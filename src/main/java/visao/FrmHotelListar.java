 ...
 * @author osmarbraz
 */
public class FrmHotelListar extends javax.swing.JFrame {

    /**
     * Creates new form FrmClienteListar
     */
    public FrmHotelListar() {
        initComponents();
        preencherTabela();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmHotelListar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void preencherTabela() {
        ...
        List<Hotel> hoteis = hoteldao.consultarTudo();
        String[] nomeColunas = {"id", "nome", "cidade", "quartos", "valor diária", "estrelas"};
        ...
        for (int i = 0; i < hoteis.size(); i++) {
            ...
            objects[0] = hotel.getHotelId();
            objects[1] = hotel.getNome();
            objects[2] = hotel.getCidade();
            objects[3] = hotel.getQuartos();
            objects[4] = hotel.getValorDiaria();
            objects[5] = hotel.getEstrelas();
